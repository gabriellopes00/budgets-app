...
function FormData(){
  ...
  return(
    <Form onSubmit={sendBudget}>
      ...
      { /* Response messages */ }
      { response.type === 'error' &&
        <Modal isOpen={ visible }  className="border-0 p-0">
          <Alert color="danger" className="border-0 m-0" toggle={onDismiss}>
            {response.message}
          </Alert>
        </Modal>
      }
      { response.type === 'success' &&
        <Modal isOpen={ visible }  className="border-0 p-0">
          <Alert color="success" className="border-0 m-0" toggle={onDismiss}>
            {response.message}
          </Alert>
        </Modal>
      }
